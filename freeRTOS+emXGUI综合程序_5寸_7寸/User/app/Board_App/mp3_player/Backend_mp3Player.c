...
#include "mp3dec.h"
#include "./app/Board_App/mp3_player/Backend_musiclist.h"
#include "emXGUI.h"
#include "x_libc.h"
#include "./app/Board_App/mp3_player/GUI_MUSICPLAYER_DIALOG.h"
#include "./app/Board_App/recorder/GUI_RECORDER_DIALOG.h"
...
void wavplayer(const char *wavfile, uint8_t vol, HDC hdc, HWND hwnd)
{
  ...
  char ooo = 0;
	...
	Recorder.ucFmtIdx=3;            /* 缺省飞利浦I2S标准，16bit数据长度，44K采样率 设置播放的音频采样率为44K */
